$(document).on("ready", function() {
    ...
    $(".x_title_hoja5").click(function(event) {
        event.preventDefault();
        var d = new Date();
        var dia = d.getDate();
    ...
    function calculaFechasHoja5(desde, hasta, elementoDom) {
        $.ajax({
            ...
            .done(function(response) {
                ...
                $("#hoja-5-edad-real-pension").val(response.difInDays);
            })
            .fail(function(statusCode, errorThrown) {
                $.unblockUI();
                ////console.log(errorThrown);
    ...
    //     totaldiasHojas5(0);
    // });
    $("#btn-cerrar-modal-hoja-5").click(function(event) {
        ...
        if (parseInt(edadPension) >= 60) {
            edadMayor = edadMayorFunc("hoja-5");
            ...
            if (edadPension < edadMayor[0].edad) {
                alertify
                    .confirm(
                        ...
                        function() {
                            totaldiasHojas5(0);
                            $("#modal-hoja-5-estrategias").modal("hide");
                        }
                    )
                    .set("labels", {
                        ok:
