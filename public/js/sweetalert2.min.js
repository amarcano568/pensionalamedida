!(function(t, e) {
    ...
    var st,
        ...
        mt = function(t) {
            ...
            if (it()) v("SweetAlert2 requires document to initialize");
                ...
                (o.className = F.container),
                    n && ut(o, F["no-transition"]),
                    M(o, ft);
                var i,
                    r,
                    a,
    ...
    var Ct = {
        ...
        St = {};
    (St.text = St.email = St.password = St.number = St.tel = St.url = function(
        t,
        e
    ) {
        return (
    ...
    function ie(t, e, n, o) {
        n
            ...
            : (Ut().then(function() {
              ...
              Kt.keydownTarget.removeEventListener(
                  "keydown",
                  Kt.keydownHandler,
            ...
            _destroy: function() {
                ...
                e &&
                    ...
                    Kt.deferDisposalTimer &&
                        (clearTimeout(Kt.deferDisposalTimer),
