                            ...
                            <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="70" style="padding: 0 20px 20px 0;">
                                        <img src="https://drive.google.com/file/d/1DwklYO4t5P1xWXbOuVy73bORskSOPi68/view?usp=sharing" alt="" width="118" height="46">
                                    </td>
                                </tr>
                            </table>
                            <!--[if (gte mso 9)|(IE)]>
                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="bodycopy">
                                        Adjunto a este correo encontrara un archivo pdf contentivo del resumen de las
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="bodycopy">
                                                    ...
                                                    manera es la Planeación. El
                                                    análisis detallado se integra
                                                    por 16 HOJAS CON
                                                    REPORTES E
                                                    INDICADORES
                                                    NUMÉRICOS, y será
                                                    enviado una vez que se
                                                    liquide el costo del plan.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
          ...
          <![endif]-->
                    ...
                    <tr>
                        <td class="innerpadding bodycopy">
                            ...
                            {{ $empresa['telefonofijo'] }} {{ $empresa['telefonoMovil'] }} o puede escribirnos al siguiente
                            correo
