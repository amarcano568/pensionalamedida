...
<head>
    ...
    <title>.:: Pensión a la Medida</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
                            ...
                            <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="70" style="padding: 0 20px 20px 0;">
                                        <img src="https://drive.google.com/file/d/1DwklYO4t5P1xWXbOuVy73bORskSOPi68/view?usp=sharing"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="h1" style="padding: 5px 0 0 0;">
                                                    ALTERNATIVAS DE PENSION - RESUMEN
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="bodycopy">
                                        Adjuntamos un archivo pdf con el resumen de su Planeación. Éste resumen es una
                                        vista general de lo que puede obtener
                                        mensualmente de pensión con las distintas alternativas de inversión que le
                                        ofrecemos en Modalidad 40.
                                    </td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                ...
                                <tr>
                                    <td class="bodycopy">Para recibir el documento en su versión completa (con las
                                        propuestas detalladas y explicadas),
                                        solicitamos por favor el 50% del pago restante.
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="bodycopy">
                                                    Puede hacer su pago a la misma cuenta donde depositó el anticipo:
                                                    <br><br>
                                                    • Tarjeta Banamex 5204 1654 0379 4393 (Oxxo o banco Banamex).
                                                    <br>
                                                    • Clabe interbancaria 0022 2570 1416 7151 97.
                                                    <br>
                                                    • A nombre de Graciela Miriam Jacinto Hernández
                                                    <br>
                                                    • Favor de enviar su comprobante de pago a:
                                                    <br>
                                                    ventas@pensionalamedida.com
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" class="footercopy">
                                        &reg; Pensión a la medida 2020<br />
                                    </td>
                                </tr>
                                <tr>
