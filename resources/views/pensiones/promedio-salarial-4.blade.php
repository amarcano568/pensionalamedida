                        ...
                        <tbody id="body-promedio-salarial-4">
                            ...
                            <tr row="2">
                                ...
                                <td class=""><input id="hoja-4-dias-mod40-alto" name="hoja-4-dias-mod40-alto"
                                        type="text" class="hoja-4-dias estrategia-6 form-control input-xs" readonly>
                                </td>
                                <td class="">
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input id="hoja-4-monto-base-mod40-alto" name="hoja-4-monto-base-mod40-alto"
                                            type="text"
                                            class="estrategia-6 form-control input-xs total-cotizacion-promedio-salarial-4"
                                            readonly>
                                    </div>
                                </td>
                                <td></td>
                            ...
                            <tr row="3">
                                ...
                                <td class=""><input id="hoja-4-dias-mod40-retroactivo"
                                        ...
                                        class="hoja-4-dias estrategia-3 form-control input-xs" readonly></td>
                                <td class="">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text input-group-text-xs">$</span>
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input id="hoja-4-monto-base-mod40-retroactivo"
                                            ...
                                            class="estrategia-3 form-control input-xs total-cotizacion-promedio-salarial-4"
                                            readonly>
                                    </div>
                                </td>
                                <td></td>
                            ...
                            <tr row="4">
                                ...
                                <td class=""><input id="hoja-4-dias-mod40-barata" name="hoja-4-dias-mod40-barata"
                                        type="text" class="hoja-4-dias estrategia-5 form-control input-xs" readonly>
                                </td>
                                <td class="">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input id="hoja-4-monto-base-mod40-barata" name="hoja-4-monto-base-mod40-barata"
                                            type="text"
                                            class="estrategia-5 form-control input-xs total-cotizacion-promedio-salarial-4"
                                            readonly>
                                    </div>
                                </td>
                                <td></td>
                            ...
                            <tr row="5">
                                ...
                                <td class=""><input id="hoja-4-dias-cooperativa" name="hoja-4-dias-cooperativa"
                                        type="text" class="hoja-4-dias estrategia-2 form-control input-xs" readonly>
                                </td>
                                <td class="">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input id="hoja-4-monto-base-cooperativa" name="hoja-4-monto-base-cooperativa"
                                            type="text"
                                            class="estrategia-2 form-control input-xs total-cotizacion-promedio-salarial-4"
                                            readonly>
                                    </div>
                                </td>
                                <td></td>
                            ...
                            <tr row="7">
                                ...
                                <td class=""><input id="hoja-4-dias-m40-pagada" name="hoja-4-dias-m40-pagada"
                                        type="text" class="hoja-4-dias estrategia-4 form-control input-xs" readonly>
                                </td>
                                <td class="">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input id="hoja-4-monto-base-m40-pagada" name="hoja-4-monto-base-m40-pagada"
                                            type="text"
                                            class="estrategia-4 form-control input-xs total-cotizacion-promedio-salarial-4"
                                            readonly>
                                    </div>
                                </td>
                                <td></td>
