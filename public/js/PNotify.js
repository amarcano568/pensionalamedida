var _extends =
    ...
    PNotify = (function() {
        "use strict";
        function t() {
            (g.defaultStack.context = document.body),
        ...
        var i = {
            runModules: function(t) {
                if ("init" === t) {
                    for (var e in g.modules)
                        if (
                            g.modules.hasOwnProperty(e) &&
                            "function" == typeof g.modules[e].init
                        ) {
                    ...
                    for (var o in n)
                        if (n.hasOwnProperty(o)) {
                            ...
                            n[o].set(s),
                                "function" == typeof n[o][t] && n[o][t]();
                        }
                }
            },
            initModule: function(t) {
                var e = this.get().modules;
                e.hasOwnProperty(t.constructor.key) ||
                    (e[t.constructor.key] = {});
                var i = _extends(
                    { _notice: this, _options: this.get() },
                    e[t.constructor.key]
            ...
            update: function(t) {
                ...
                return (
                    n !== i &&
                        ((!0 === n && "fontawesome5" === this.get().icons) ||
                            ("string" == typeof n &&
                                n.match(/(^| )fa[srlb]($| )/))) &&
                        (this.set({ icon: !1 }), this.set({ icon: n })),
                    this
                );
            },
            open: function() {
                ...
                if ("opening" !== i) {
                    if ("open" !== i) {
                        ...
                        if (
                            ...
                            (o &&
                                o.context &&
                                o.context !== this.refs.elem.parentNode)
                        )
                            if (o && o.context)
                                o.context.appendChild(this.refs.elem);
                            else {
                                if (!document.body)
                                    throw new Error(
                                        "No context to open this notice in."
                                    );
            ...
            close: function(t) {
                ...
                if ("closing" !== i && "closed" !== i) {
                    ...
                    return (
                        n &&
                            clearTimeout &&
                            (clearTimeout(n), this.set({ _timer: null })),
                        this.animateOut(function() {
                            if (
                                ...
                                e.queuePosition(),
                                e.get().remove &&
                                    e.refs.elem.parentNode.removeChild(
                                        e.refs.elem
                                    ),
                                e.runModules("beforeDestroy"),
                                e.get().destroy && null !== g.notices)
                            ) {
                                var t = g.notices.indexOf(e);
                                -1 !== t && g.notices.splice(t, 1);
                            }
            ...
            animateIn: function(a) {
                ...
                function l() {
                    ...
                    if ((e && clearTimeout(e), "in" === i)) {
                        ...
                        o
                            ? (a && a.call(), c.set({ _animating: !1 }))
                            : c.set({ _animTimer: setTimeout(l, 40) });
                    }
                }
                "fade" === this.get().animation
                    ? (this.refs.elem.addEventListener("transitionend", l),
                      this.set({ _animatingClass: "ui-pnotify-in" }),
                      this.refs.elem.style.opacity,
                      this.set({
                          _animatingClass: "ui-pnotify-in ui-pnotify-fade-in"
                      }),
                      this.set({ _animTimer: setTimeout(l, 650) }))
                    : (this.set({ _animatingClass: "ui-pnotify-in" }), l());
            },
            animateOut: function(f) {
                ...
                function p() {
                    ...
                    if ((e && clearTimeout(e), "out" === i)) {
                        ...
                        if (
                            d.refs.elem.style.opacity &&
                            "0" !== d.refs.elem.style.opacity &&
                            o
                        )
                            d.set({ _animTimer: setTimeout(p, 40) });
                        else {
                ...
                "fade" === this.get().animation
                    ? (this.refs.elem.addEventListener("transitionend", p),
                      this.set({ _animatingClass: "ui-pnotify-in" }),
                      this.set({ _animTimer: setTimeout(p, 650) }))
                    : (this.set({ _animatingClass: "" }), p());
            },
            position: function() {
                ...
                if (t) {
                    ...
                    t.modal &&
                        (t.overlay ||
                            ...
                            n.context !== document.body &&
                                ((o.style.height =
                                    n.context.scrollHeight + "px"),
                                (o.style.width = n.context.scrollWidth + "px")),
                            o.addEventListener("click", function() {
                                n.overlayClose && g.closeStack(n);
                            }),
                            (n.overlay = o)),
                        (i = t).overlay.parentNode !== i.context &&
                            (i.overlay = i.context.insertBefore(
                                i.overlay,
                                i.context.firstChild
                            ))),
                    ...
                    if (t.dir1) {
                        ...
                        void 0 === t.firstpos1 &&
                            ((t.firstpos1 = c), (t.nextpos1 = t.firstpos1));
                    }
                    if (t.dir1 && t.dir2) {
                        var l = {
                                down: "top",
                        ...
                        void 0 === t.firstpos2 &&
                            ((t.firstpos2 = u), (t.nextpos2 = t.firstpos2));
                        var f =
                                t.nextpos1 +
                                e.offsetHeight +
                            ...
                            d =
                                ...
                                (void 0 === t.spacing1 ? 25 : t.spacing1);
                        switch (
                            (((("down" === t.dir1 || "up" === t.dir1) &&
                                s < f) ||
                                (("left" === t.dir1 || "right" === t.dir1) &&
                                    r < d)) &&
                                ((t.nextpos1 = t.firstpos1),
                                (t.nextpos2 +=
                                    t.addpos2 +
                                    (void 0 === t.spacing2 ? 25 : t.spacing2)),
                                (t.addpos2 = 0)),
                            "number" == typeof t.nextpos2 &&
                                ((e.style[l] = t.nextpos2 + "px"),
                                t.animation || e.style[l]),
                            t.dir2)
                        ) {
                            case "down":
                            case "up":
                                e.offsetHeight +
                                    ...
                                    (parseFloat(e.style.marginBottom, 10) ||
                                        0) >
                        ...
                        switch (t.dir1) {
                            ...
                            case "up":
                                (m = ["left", "right"]),
                                    (p =
                                        t.context.scrollWidth / 2 -
                                        e.offsetWidth / 2);
                                break;
                            case "left":
                            case "right":
                                (m = ["top", "bottom"]),
                                    (p = s / 2 - e.offsetHeight / 2);
                        }
                        (e.style[m[0]] = p + "px"),
                            (e.style[m[1]] = "auto"),
                            t.animation || e.style[m[0]];
                    }
                    if (t.dir1)
                        switch (
                            ("number" == typeof t.nextpos1 &&
                                ((e.style[a] = t.nextpos1 + "px"),
                                t.animation || e.style[a]),
                            t.dir1)
                        ) {
                            case "down":
                            case "up":
        ...
        function $(i, t) {
            ...
            return {
                ...
                d: function(t) {
                    t && ot(n),
                        i.refs.iconContainer === n &&
                            (i.refs.iconContainer = null);
                }
            };
        }
        function G(i, t) {
            ...
            return {
                c: function() {
                    (n = Q("h4")),
                        ...
                        (n.className = o =
                            "ui-pnotify-title " +
                            (t._styles.title ? t._styles.title : ""));
                },
                m: function(t, e) {
                ...
                p: function(t, e) {
                    r === (r = s(e)) && a
                        ? a.p(t, e)
                        : (a.d(1), (a = r(i, e)).c(), a.m(n, null)),
                        t._styles &&
                            o !==
                                (o =
                                    "ui-pnotify-title " +
                                    (e._styles.title ? e._styles.title : "")) &&
                            (n.className = o);
                },
                d: function(t) {
                    t && ot(n),
                        a.d(),
                        i.refs.titleContainer === n &&
                            (i.refs.titleContainer = null);
                }
            };
        }
        function c(t, e) {
        ...
        function l(t, i) {
            ...
            return {
                ...
                m: function(t, e) {
                    et(t, n, e),
                        n.insertAdjacentHTML("afterend", i.title),
                        et(t, o, e);
                },
                p: function(t, e) {
                    t.title &&
                        (r(n, o), n.insertAdjacentHTML("afterend", e.title));
                },
                d: function(t) {
                    t && (r(n, o), ot(n), ot(o));
                }
                    ...
                    r === (r = s(e)) && a
                        ...
                        t._styles &&
                            o !==
                                (o =
                                    "ui-pnotify-text " +
                                    (e._styles.text ? e._styles.text : "")) &&
                            (n.className = o);
                },
                d: function(t) {
                    t && ot(n),
                        a.d(),
                        i.refs.textContainer === n &&
                            (i.refs.textContainer = null);
                }
            };
        }
        function u(t, e) {
        ...
        function f(t, i) {
            ...
            return {
                ...
                m: function(t, e) {
                    et(t, n, e),
                        n.insertAdjacentHTML("afterend", i.text),
                        et(t, o, e);
                },
                p: function(t, e) {
                    t.text &&
                        (r(n, o), n.insertAdjacentHTML("afterend", e.text));
                },
                d: function(t) {
                    t && (r(n, o), ot(n), ot(o));
                }
            ...
            (i = t),
                ...
                (this._state = a(
                    (((n = _extends(
                        ...
                        g.defaults
                    )).modules = _extends({}, g.defaults.modules)),
                    n),
                    t.data
                )),
                this._recompute(
                ...
                document.getElementById("svelte-1eldsjg-style") ||
                    (((o = Q("style")).id = "svelte-1eldsjg-style"),
                    (o.textContent =
                    ...
                    return {
                        c: function() {
                            ...
                            (r.className = f =
                                ...
                                "\n      "),
                                (r.style.cssText = d =
                                    t._widthStyle + " " + t._minHeightStyle),
                                Z(r, "role", "alert"),
                                tt(s, "mouseover", N),
                                tt(s, "mouseout", H),
                                tt(s, "mouseenter", M),
                                ...
                                (s.className = p =
                                    ...
                                    "\n      " +
                                    ("fade" === t.animation
                                        ? "ui-pnotify-fade-" + t.animateSpeed
                                        : "") +
                                    "\n      " +
                                    (t.stack && t.stack.modal
                                        ? "ui-pnotify-modal"
                                        : "") +
                                    "\n      " +
                                    t._moduleClasses.join(" ") +
                                    "\n    "),
                                Z(s, "aria-live", "assertive"),
                                Z(s, "role", "alertdialog"),
                                Z(s, "ui-pnotify", !0);
                        },
                        m: function(t, e) {
                            for (
                        ...
                        d: function(t) {
                            for (t && ot(s), i = 0; i < m.length; i += 1)
                                m[i].d();
                            for (
                                x && x.d(), C && C.d(), w && w.d(), i = 0;
                                i < y.length;
                                i += 1
                            )
                                y[i].d();
                            o.refs.container === r && (o.refs.container = null),
                                ...
                                st(s, "touchend", B),
                                st(s, "touchcancel", I),
                                o.refs.elem === s && (o.refs.elem = null);
                        }
                    };
                })(this, this._state)),
        ...
        function it(t, e, i, n, o, s, r, a, c, l, u, f, d, p) {
            for (var m = t.length, h = r.length, y = m, g = {}; y--; )
                g[t[y].key] = y;
            var _ = [],
                v = {},
                b = {};
            for (y = h; y--; ) {
                var x = p(s, r, y),
                    C = n(x),
                    w = a[C];
                w ? o && w.p(i, x) : (w = u(e, C, x)).c(),
                    (_[y] = v[C] = w),
                    C in g && (b[C] = Math.abs(y - g[C]));
            }
            var k = {},
                T = {};
            function S(t) {
        ...
        return (
            a(o.prototype, {
                ...
                _set: function(t) {
                    var e = this._state,
                        i = {},
                        n = !1;
                    for (var o in ((t = a(this._staged, t)),
                    (this._staged = {}),
                    t))
                        this._differs(t[o], e[o]) && (i[o] = n = !0);
                    if (!n) return;
                    (this._state = a(a({}, e), t)),
                        this._recompute(i, this._state),
                        this._bind && this._bind(i, this._state);
                    this._fragment &&
                        (this.fire("state", {
                            changed: i,
                            current: this._state,
                        ...
                        this._fragment.p(i, this._state),
                        this.fire("update", {
                            changed: i,
                            current: this._state,
                            previous: e
            ...
            a(o.prototype, i),
            (o.prototype._recompute = function(t, e) {
                var i, n, o, s;
                t.styling &&
                    this._differs(
                        e._styles,
            ...
            (g.closeAll = function() {
                for (var t = 0; t < g.notices.length; t++)
                    g.notices[t].close && g.notices[t].close(!1);
            }),
            ...
            (g.closeStack = function(t) {
                if (!1 !== t)
                    for (var e = 0; e < g.notices.length; e++)
                        g.notices[e].close &&
                            g.notices[e].get().stack === t &&
                            g.notices[e].close(!1);
            }),
            (g.positionAll = function() {
                if ((n && clearTimeout(n), (n = null), 0 < g.notices.length)) {
                    ...
                    for (var i = 0; i < g.notices.length; i++)
                        g.notices[i].position();
                } else
                    delete g.defaultStack.nextpos1,
                        delete g.defaultStack.nextpos2;
            }),
            (g.styling = {
                brighttheme: {
