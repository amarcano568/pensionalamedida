    ...
    public function actualizarCliente(Request $request)
    {
        ...
        try {
            ...
            if ( is_null($request->idCliente) ){  
                ...
                $customMessages =   [
                                        'email.unique' => '<i class="fas fa-exclamation-triangle"></i> Existe otro Cliente con ese <strong>Correo</strong>',
                                        'nroDocumento.unique'  => '<i class="fas fa-exclamation-triangle"></i> Existe otro Cliente con ese <strong>Nro. de Documento</strong>',
                                    ];                                
