        ...
        <div class="modal-body">
            ...
            <div class="x_panel">
                ...
                <div estrategia="1" class="x_content" style="display: block;">
                    <table id="table-estrategia-1" style="display: table;width: 100%" class="table">
                        <tbody id="body-estrategia-1">
                            <tr style="background-color: #EBEDEF">
            ...
            <div class="x_panel">
                ...
                <div estrategia="2" class="x_content" style="display: block;">
                    <table id="table-estrategia-2" style="display: table;width: 100%" class="table">
            ...
            <div class="x_panel">
                ...
                <div estrategia="3" class="x_content" style="display: block;">
                    <table id="table-estrategia-3" style="display: table;width: 100%" class="table">
                        <tbody id="body-estrategia-3">
                            <tr style="background-color: #EBEDEF">
                                <td style="width: 10%" class="text-center">Desde</td>
            ...
            <div class="x_panel">
                ...
                <div estrategia="4" class="x_content" style="display: block;">
                    <table id="table-estrategia-4" style="display: table;width: 100%" class="table">
                        <tbody id="body-estrategia-4">
                            <tr style="background-color: #EBEDEF">
                                <td style="width: 10%" class="text-center">Desde</td>
            ...
            <div class="x_panel">
                ...
                <div estrategia="5" class="x_content" style="display: block;">
                    <table id="table-estrategia-5" style="display: table;width: 100%" class="table">
                        <tbody id="body-estrategia-5">
                            <tr style="background-color: #EBEDEF">
                                <td style="width: 10%" class="text-center">Desde</td>
            ...
            <div class="x_panel">
                ...
                <div estrategia="6" class="x_content" style="display: block;">
                    <table id="table-estrategia-6" style="display: table;width: 100%" class="table">
                        <tbody id="body-estrategia-6">
                            <tr style="background-color: #EBEDEF">
                                <td style="width: 10%" class="text-center">Desde</td>
