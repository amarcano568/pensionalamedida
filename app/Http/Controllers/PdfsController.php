...
class PdfsController extends Controller
{
    ...
    public function verPdfResumen(Request $request)
    {
        ...
        \PDF::loadView('pdf.resumenpdf', $data)->setPaper('letter', 'landscape')->save($nameFilePdf);
        return response()->json(array('success' => true, 'mensaje' => 'Pdf resumen generado exitosamente', 'data' => '/' . $nameFilePdf, 'email' => $cliente->email));
    }
